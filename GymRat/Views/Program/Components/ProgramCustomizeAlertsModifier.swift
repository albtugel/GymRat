...
struct ProgramCustomizeAlertsModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .alert(LocalizedStringKey(AppAlerts.SharedHistory.title), isPresented: sharedHistoryAlertBinding) {
            ...
            .alert(LocalizedStringKey(AppAlerts.NoSharedExercise.title), isPresented: noSharedExerciseAlertBinding) {
            ...
            .alert(LocalizedStringKey(AppAlerts.ProgramDaysRequired.title), isPresented: weekdaysRequiredAlertBinding) {
                Button("ok_button", role: .cancel) {
